...
if (dayOfWeek >= 1 && dayOfWeek <= 5) {
  ...
  messageA = "Woohoo!  It is the weekend!";
}
...
switch (dayOfWeek) {
  ...
  case 6:
    ...
    break;
  default:
    messageB = "Unknown - " + dayOfWeek;
    break;
}

/* OUTPUT */

// Step 1: Assign the value of the first message variable to the HTML element with an ID of messageA
document.querySelector("#messageA").textContent = messageA;

// Step 2: Assign the value of the second message variable to the HTML element with an ID of messageB
document.querySelector("#messageB").textContent = messageB;
